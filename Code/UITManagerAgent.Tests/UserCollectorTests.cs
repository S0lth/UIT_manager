...
public class UserCollectorTests
{
    ...
    /// <summary>
    /// Tests if the <see cref="UserCollector.Collect"/> method returns a non-null and non-empty list of users when users exist.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tests if the <see cref="UserCollector.Collect"/> method returns a new instance of <see cref="UsersInformation"/> on each call.
    /// </summary>
    [TestMethod]
